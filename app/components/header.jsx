...
const Header = ({ activeTab = 'الرئيسية' }) => {
  // ترتيب الروابط كما يظهر في التصميم
        ...
        {navLinks.map((link) => (
          <a
            ...
            className={`pb-2 text-sm font-medium transition-colors ${
              activeTab === link
                ? 'text-[#169b8b] border-b-2 border-[#169b8b]' // ستايل الرابط النشط
                : 'text-gray-600 hover:text-[#0a4240]'       // ستايل الروابط العادية
            }`}
          >
            {link}
          </a>
